...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/livro/all',
            ...(fetchMiddlewares<RequestHandler>(LivroController)),
            ...(fetchMiddlewares<RequestHandler>(LivroController.prototype.filtrarCategorias)),

            async function LivroController_filtrarCategorias(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    fail: {"in":"res","name":"400","required":true,"ref":"BasicResponseDto"},
                    sucess: {"in":"res","name":"201","required":true,"ref":"BasicResponseDto"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/emprestimo/livro/:idLivro',
            ...(fetchMiddlewares<RequestHandler>(EmprestimoController)),
            ...(fetchMiddlewares<RequestHandler>(EmprestimoController.prototype.filtrarEmprestimoPorLivro)),

            async function EmprestimoController_filtrarEmprestimoPorLivro(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    idLivro: {"in":"path","name":"idLivro","required":true,"dataType":"double"},
                    fail: {"in":"res","name":"400","required":true,"ref":"BasicResponseDto"},
                    success: {"in":"res","name":"201","required":true,"ref":"BasicResponseDto"},
            };
            ...
            try {
              ...
              await templateService.apiHandler({
                methodName: 'filtrarEmprestimoPorLivro',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/emprestimo/usuario/:usuarioID',
            ...(fetchMiddlewares<RequestHandler>(EmprestimoController)),
            ...(fetchMiddlewares<RequestHandler>(EmprestimoController.prototype.filtrarEmprestimoPorUsuario)),

            async function EmprestimoController_filtrarEmprestimoPorUsuario(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            ...
            try {
              ...
              await templateService.apiHandler({
                methodName: 'filtrarEmprestimoPorUsuario',
                controller,
                response,
                next,
                validatedArgs,
        ...
        app.get('/categoria/all',
            ...(fetchMiddlewares<RequestHandler>(CategoriaController)),
            ...(fetchMiddlewares<RequestHandler>(CategoriaController.prototype.listarTodosCategoria)),

            async function CategoriaController_listarTodosCategoria(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    fail: {"in":"res","name":"400","required":true,"ref":"BasicResponseDto"},
                    sucess: {"in":"res","name":"201","required":true,"ref":"BasicResponseDto"},
            };
            ...
            try {
              ...
              await templateService.apiHandler({
                methodName: 'listarTodosCategoria',
                controller,
                response,
                next,
                validatedArgs,
